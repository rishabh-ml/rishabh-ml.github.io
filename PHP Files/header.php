...
<head>
    ...
    <meta property="og:image" content="https://srtechnicals.com/<?php echo $og_image; ?>">
    ...
    <meta name="twitter:image" content="https://srtechnicals.com/<?php echo $twitter_image; ?>">
...
<body>
    ...
    <header>
        <div class="logo">
            <img src="logo.svg" alt="Syed Rizvi Technical Services Logo" title="Syed Rizvi Technical Services L.L.C">
        </div>
        <nav>
